...
var STEPS = "KYUDA_STEPS"
var EXPORTS = "KYUDA_EXPORTS"
...
func TestExport(t *testing.T) {
	testname := fmt.Sprintf("$KYUDA_EXPORTS file holds the correct data")
	t.Run(testname, func(t *testing.T) {
		value := "value"
		key := "key"
		Export(key, value)
...
func TestSteps(t *testing.T) {
	testname := fmt.Sprintf("Steps holds the value of $KYUDA_STEPS")
	t.Run(testname, func(t *testing.T) {
